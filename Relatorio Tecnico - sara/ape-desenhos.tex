...
Neste apêndice serão apresentados os \emph{scripts} dos desenhos dos modelos realizados em \ac{3D}.\\

Arquivos faltantes podem ser encontrados no sítio: \url{https://github.com/Metamaquina/Metamaquina2}
